...
class UpDownTool(tk.Toplevel):
    ...
    def build_top_section(self, parent):
        ...
        strategies = [
            ...
            ("Put and Stock", self.strat_stock_put, [("Put Stock", "put_strike")]),
            ("Call Outright", self.strat_call_outright, [("Call Stock", "strike")]),
            ("Put Outright", self.strat_put_outright, [("Put Stock", "strike")]),
            ("Call Spread", self.strat_call_spread, [("Low Stock", "low_strike"), ("High Stock", "high_strike")]),
            ("Call 1x2", self.strat_call_spread_one_by_two, [("Low Stock", "low_strike"), ("High Stock", "high_strike")]),
            ("Call Backspread 1x2", self.strat_call_backspread_2x1, [("Short Low Stock", "short_low"), ("Long High Stock", "long_high")]),
            ("Call Backspread 1x3", self.strat_call_backspread_3x1, [("Short Low Stock", "short_low"), ("Long High Stock", "long_high")]),
            ("Put Backspread 1x2", self.strat_put_backspread_2x1, [("Short High Stock", "short_high"), ("Long Low Stock", "long_low")]),
            ("Put Backspread 1x3", self.strat_put_backspread_3x1, [("Short High Stock", "short_high"), ("Long Low Stock", "long_low")]),
            ("Call Butterfly", self.strat_call_butterfly, [("Low Stock", "k_low"), ("Mid Stock", "k_mid"), ("High Stock", "k_high")]),
            ("Put Butterfly", self.strat_put_butterfly, [("Low Stock", "k_low"), ("Mid Stock", "k_mid"), ("High Stock", "k_high")]),
            ("Bullish Risk Reversal", self.strat_bullish_risk_reversal, [("Call Stock", "call_strike"), ("Put Stock", "put_strike")]),
            ("Buy Stock Sell Call", self.strat_buy_write, [("Call Stock", "call_strike")]),
            ("Straddle", self.strat_straddle, [("Strike", "strike")]),
            ("Collar (w/ stock)", self.strat_collar, [("Put Stock", "put_strike"), ("Call Stock", "call_strike")]),
            ("Collar (no stock)", self.strat_collar_no_stock, [("Put Stock", "put_strike"), ("Call Stock", "call_strike")]),
            ("Call-Spread Collar", self.strat_call_spread_collar, [("Put Stock", "put_strike"), ("Call Low Stock", "call_low"), ("Call High Stock", "call_high")]),
            ("Put-Spread Collar", self.strat_put_spread_collar, [("Put High Stock", "put_high"), ("Put Low Stock", "put_low"), ("Call Stock", "call_strike")]),
            ("Put-Spread Collar + Stock", self.strat_put_spread_collar_with_stock, [("Put High Stock", "put_high"), ("Put Low Stock", "put_low"), ("Call Stock", "call_strike")]),
            ("Call Tree 1x1x1", self.strat_call_tree_1x1x1, [("Long Stock1", "k1_long"), ("Short Stock2", "k2_short"), ("Short Stock3", "k3_short")]),
            ("Put Tree 1x1x1", self.strat_put_tree_1x1x1, [("Short Stock1", "k1_short"), ("Short Stock2", "k2_short"), ("Long Stock3", "k3_long")]),
        ]
